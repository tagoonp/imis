...
function fetchMarker(){
  ...
  $urlsd = 'http://k4ds.psu.ac.th/rsis/imis/core/fetch-marker-province.php';
  $level = $('#txtLevel').val();
  switch($level){
    case '1': $urlsd = 'http://k4ds.psu.ac.th/rsis/imis/core/fetch-marker-province.php'; break; //ระดับจังหวัด
    case '2': $urlsd = 'http://k4ds.psu.ac.th/rsis/imis/core/fetch-marker-district.php'; break; //ระดับอำเภอ
    case '3': $urlsd = 'http://k4ds.psu.ac.th/rsis/imis/core/fetch-marker-tumbon.php'; break; //ระดับจังหวัด
    case '4': $urlsd = 'http://k4ds.psu.ac.th/rsis/imis/core/fetch-marker-mongo.php'; break; //ระดับจังหวัด
  ...
  // $.post($urlsd , {sdate: $('#txtStart').val() , edate: $('#txtEnd').val(), sage: $('#txtAgestart').val() ,eage: $('#txtAgeend').val() , itemsdb: $items, isdb: $is, evt1: $road , evt2: $water , evt3: $fall } , function(data) {
  //
  //   if(data.length==0){
  //     swal("ไม่พบข้อมูล");
  //   }else{
