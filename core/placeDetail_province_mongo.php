...
$cursor = $collection->find(array("province" => intval($id)));
$cursor->limit(1);
$provName = '';
...
<div class="" style="background: red; padding: 10px; font-size: 16px; margin: 0px; color: #000; font-weight: bold; font-family: 'Kanit', sans-serif;">
  ข้อมูลสถานที่ <span style="font-size: 0.8em;"><font color="#fff">จังหวัด<?php print $provName; ?></span></font>
</div>
      ...
      <tr>
        ...
        <td>
          ...
          if($_POST['evt1']=='true'){
            ...
            array( '$and' =>
                array(
                  array('province' => intval($id)),
                  array('age' => array('$gte' => intval($ageStart))),
                  array('age' => array('$lte' => intval($ageEnd))),
