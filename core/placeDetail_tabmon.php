...
$strSQL = "SELECT a.Name provname, b.Name distName, c.Name tumbonName
FROM
td3s_changwat a inner join td3s_ampur b on a.Changwat = b.Changwat
inner join td3s_tumbon c on a.Changwat = c.Changwat and b.Ampur = c.Ampur
WHERE c.Changwat = '".$id."' and c.Ampur = '".$id2."' and c.Tumbon = '".$id3."'";
...
if($result){
  ...
  <div style="padding: 10px; background: #f3f3f3; font-family: 'Kanit', sans-serif;">
    <strong>จังหวัด</strong> : <?php print $result[0]['provname']; ?><br>
    <strong>อำเภอ</strong> : <?php print $result[0]['distName']; ?><br>
    <strong>ตำบล</strong> : <?php print $result[0]['tumbonName']; ?>
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==1){
              ...
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and tumbon_id = '".$id3."' and atype = '1'
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==2){
              ...
              FROM td3s_linked_data_test
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and tumbon_id = '".$id3."' and atype = '2'
              and adate between '".$dateStart."' and '".$dateEnd."'
              and pat_age between '".$ageStart."' and '".$ageEnd."'
              and is_is = '".$itemcb."'
              and is_items = '".$iscb."'";
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==3){
              ...
              FROM td3s_linked_data_test
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and tumbon_id = '".$id3."' and atype = '3'
              and adate between '".$dateStart."' and '".$dateEnd."'
              and pat_age between '".$ageStart."' and '".$ageEnd."'
              and is_is = '".$itemcb."'
              and is_items = '".$iscb."'";
