...
$strSQL = "SELECT a.Name provname, b.Name distName
FROM td3s_changwat a inner join td3s_ampur b on a.Changwat = b.Changwat WHERE b.Changwat = '".$id."' and b.Ampur = '".$id2."'";
$result = $db->select($strSQL,false,true);

if($result){
  ?>
  <div class="" style="background: red; padding: 10px; font-size: 16px; margin: 0px; color: #fff; font-weight: bold; font-family: 'Kanit', sans-serif;">
    ข้อมูลสถานที่
  </div>
  ...
  <div style="padding: 10px; background: #f3f3f3; font-family: 'Kanit', sans-serif;">
    ...
    <strong>อำเภอ</strong> : <?php print $result[0]['distName']; ?>
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==1){
              ...
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and atype = '1'
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==2){
              ...
              FROM td3s_linked_data_test
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and atype = '2'
              and adate between '".$dateStart."' and '".$dateEnd."'
              and pat_age between '".$ageStart."' and '".$ageEnd."'
              and is_is = '".$itemcb."'
              and is_items = '".$iscb."'";
        ...
        <td style="padding: 5px;">
          ...
          foreach ($buff as $value) {
            if($value==3){
              ...
              FROM td3s_linked_data_test
              WHERE
              prov_id = '".$id."' and district_id = '".$id2."' and atype = '3'
              and adate between '".$dateStart."' and '".$dateEnd."'
              and pat_age between '".$ageStart."' and '".$ageEnd."'
              and is_is = '".$itemcb."'
              and is_items = '".$iscb."'";
